...
class trainer():
    def __init__(self):
        self.get_config()
        # print("[INFO] Loaded config file successfully.")
        self.get_save_path()
        # print("[INFO] Got save path successfully.")
        self.env = gym.make('CustomMountainCar-v0',
                            action = self.action,
                            gravity = self.gravity,
                            render_mode="rgb_array")
        # print("[INFO] Created environment successfully.")
        self.n_action = len(self.action)
        # print(f"[INFO] Action space number : {self.n_action}")
        self.get_models()
    ...
    def get_config(self):
        ...
        self.gravity = self.config_dic['gravity']
    ...
    def get_save_path(self):
        number = len(glob(os.path.join(os.getcwd(), 'runs', 'action_remap', 'CustomMountainCar-v0', 'train', 'model_*')))
        save_dir = os.path.join(os.getcwd(), 'runs', 'action_remap', 'CustomMountainCar-v0', 'train', f'model_{number}')
    ...
    def get_models(self):
        ...
        # print(f"[INFO] Initialized Action Remap Network Successfully.")
    ...
    def update_model(self):
        ...
        with tf.GradientTape() as tape:
            ...
            # print(f"[INFO] Action label inference complete.")
            loss = get_loss_map(action_mapped, action_label)
            # print(f"[INFO] Loss calculation complete.")
        ...
        # print(f"[INFO] Backpropagation complete.")
    ...
    def env_init(self):
        ...
        # print(f"[INFO] Initialized Environment Successfully.")
        # print(f"[INFO] Initial states : {self.state}")
    ...
    def train_step(self, n):
        ...
        # print(f"[INFO] E-greedy action complete.")

        next_state, reward, terminated, truncated, info = self.env.step(action)
        self.done = terminated or truncated
        # print(f"[INFO] Observe next state complete.")
    ...
    def train(self):
        ...
        for n in range(self.epochs):
            ...
            while not self.done:
                self.train_step(n)
            print(f"[INFO] Train step complete.")
